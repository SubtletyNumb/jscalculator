...
const calculatorSlice = createSlice({
  ...
  getResult: (state) => {
    ...
    //evalOperation is a string created by chaining a series of replace method statements to make the operation evaluable for
    //the evaluate method from mathjs library.
  //  let evalOperation = getFilteredOperationString(state.innerOperation);
  //  console.log(evalOperation);
   document.getElementById('operation-display').innerText = String(evaluate(state.innerOperation));
    // state.displayText = String(evaluate(evalOperation))
    // state.result = String(evaluate());
